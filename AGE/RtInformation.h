...
namespace AGE{
	...
	class RtInformation : public Singleton<RtInformation>{
	public:
		RtInformation();
		~RtInformation() {}
		void FrameStart()
	...
	inline RtInformation::RtInformation()
		:mCpuLogicTime(0), mCpuRenderingTime(0), mFps(0)
	{
	}

	static inline RtInformation* GetRtInformation() { return RtInformation::GetInstance(); }
}
